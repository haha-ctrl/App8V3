...
"C:\\Users\\PC\\AppData\\Local\\Android\\Sdk\\cmake\\3.22.1\\bin\\cmake.exe" ^
  ...
  "-DCMAKE_LIBRARY_OUTPUT_DIRECTORY=D:\\AndroidStudioProjects\\App8V2\\openCV\\build\\intermediates\\cxx\\Debug\\3w2l1s86\\obj\\armeabi-v7a" ^
  "-DCMAKE_RUNTIME_OUTPUT_DIRECTORY=D:\\AndroidStudioProjects\\App8V2\\openCV\\build\\intermediates\\cxx\\Debug\\3w2l1s86\\obj\\armeabi-v7a" ^
  "-DCMAKE_BUILD_TYPE=Debug" ^
  "-BD:\\AndroidStudioProjects\\App8V2\\openCV\\.cxx\\Debug\\3w2l1s86\\armeabi-v7a" ^
  -GNinja ^
